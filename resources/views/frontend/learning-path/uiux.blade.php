...
@section('content')
    <div class="container mt-5">
        <h1 class="fw-bold text-center text-dark animate__animated animate__fadeInDown">Kursus UI/UX</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 animate__animated animate__fadeInRight">
                    <div class="video-container mt-4 bg-dark rounded">
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/71a2zeC71gk?si=QOzWhGE1VP9SBxaz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
