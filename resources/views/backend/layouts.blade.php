                    ...
                    <ul class="nav nav-secondary">
                        <li class="nav-item {{ Request::is('dashboard-admin') ? 'active' : '' }}">
                            <a data-bs-toggle="collapse" href="#dashboard"
                                class="{{ Request::is('dashboard-admin') ? '' : 'collapsed' }}"
                                aria-expanded="{{ Request::is('dashboard-admin') ? 'true' : 'false' }}">
                                <i class="fas fa-home"></i>
                                <p>Dashboard</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse {{ Request::is('dashboard-admin') ? 'show' : '' }}" id="dashboard">
                        ...
                        <li class="nav-item {{ Request::is('dashboard-admin/configuration') ? 'active' : '' }}">
                        ...
                        <ul class="nav">
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="base">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.avatars') }}"><span
                                                    class="sub-item">Avatars</span></a></li>
                                        <li><a href="{{ route('admin.buttons') }}"><span
                                                    class="sub-item">Buttons</span></a></li>
                                        <li><a href="{{ route('admin.grid-system') }}"><span class="sub-item">Grid
                                                    System</span></a></li>
                                        <li><a href="{{ route('admin.panels') }}"><span
                                                    class="sub-item">Panels</span></a></li>
                                        <li><a href="{{ route('admin.notifications') }}"><span
                                                    class="sub-item">Notifications</span></a></li>
                                        <li><a href="{{ route('admin.sweet-alert') }}"><span class="sub-item">Sweet
                                                    Alert</span></a></li>
                                        <li><a href="{{ route('admin.font-awesome-icons') }}"><span
                                                    class="sub-item">Font Awesome Icons</span></a></li>
                                        <li><a href="{{ route('admin.simple-line-icons') }}"><span
                                                    class="sub-item">Simple Line Icons</span></a></li>
                                        <li><a href="{{ route('admin.typography') }}"><span
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="sidebarLayouts">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.sidebar-style-2') }}"><span
                                                    class="sub-item">Sidebar Style 2</span></a></li>
                                        <li><a href="{{ route('admin.icon-menu') }}"><span class="sub-item">Icon
                                                    Menu</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="forms">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.forms') }}"><span class="sub-item">Basic
                                                    Form</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="tables">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.tables') }}"><span class="sub-item">Basic
                                                    Table</span></a></li>
                                        <li><a href="{{ route('admin.data-tables') }}"><span
                                                    class="sub-item">Datatables</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="maps">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.google-maps') }}"><span class="sub-item">Google
                                                    Maps</span></a></li>
                                        <li><a href="{{ route('admin.jsvectormap') }}"><span
                                                    class="sub-item">Jsvectormap</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="charts">
                                    <ul class="nav nav-collapse">
                                        <li><a href="{{ route('admin.charts') }}"><span class="sub-item">Chart
                                                    Js</span></a></li>
                                        <li><a href="{{ route('admin.sparkline') }}"><span
                                                    class="sub-item">Sparkline</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                ...
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="dark">
                        <a href="index.html" class="logo">
                            <img src="backend/assets/img/kaiadmin/logo_light.svg" alt="navbar brand"
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="backend/assets/img/jm_denis.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="backend/assets/img/chadengle.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="backend/assets/img/profile2.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
